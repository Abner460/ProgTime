...
namespace ProgJogador
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            time1.contratarJogador(new Jogador("Antônio",  29, 88, 8));
            ...
            time2.contratarJogador(new Jogador("Roberto",  27, 91, 3));
            ...
            time2.contratarJogador(new Jogador("Otávio",   29, 88, 8));
            time2.contratarJogador(new Jogador("Márcio",   25, 79, 9));
            ...
            p1.jogar();
            System.Console.WriteLine(p1.getPlacar());

            System.Console.WriteLine(time1.getStatus());
            time1.getDescricaoJogadores();

            System.Console.WriteLine(time2.getStatus());
